...
The first line contains an integer t (1 ≤q t ≤q 5000), the number of test cases.

The first line of each test case contains an integer n (1 ≤q n ≤q 10).

The second line of each test case contains n integers, the elements of a (1 ≤q a_i ≤q 10).
