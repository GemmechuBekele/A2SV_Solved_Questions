...
Each test consists of several test cases. The first line contains a single integer t (1 ≤ t ≤ 10⁴) — the number of test cases. The following lines describe the test cases.
